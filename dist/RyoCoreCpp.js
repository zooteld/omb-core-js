...
var RyoCoreCpp = function () {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  return function (RyoCoreCpp) {
    RyoCoreCpp = RyoCoreCpp || {};

    var Module = typeof RyoCoreCpp !== "undefined" ? RyoCoreCpp : {};var moduleOverrides = {};var key;for (key in Module) {
      ...
      scriptDirectory = __dirname + "/";var nodeFS;var nodePath;Module["read"] = function shell_read(filename, binary) {
        var ret;if (!nodeFS) nodeFS = require("fs");if (!nodePath) nodePath = require("path");filename = nodePath["normalize"](filename);ret = nodeFS["readFileSync"](filename);return binary ? ret : ret.toString();
    ...
    }moduleOverrides = undefined;function dynamicAlloc(size) {
      var ret = HEAP32[DYNAMICTOP_PTR >> 2];var end = ret + size + 15 & -16;if (end <= _emscripten_get_heap_size()) {
        ...
        debugger;
      } };var functionPointers = new Array(0);var tempRet0 = 0;var setTempRet0 = function setTempRet0(value) {
      tempRet0 = value;
    };var getTempRet0 = function getTempRet0() {
      return tempRet0;
    };var GLOBAL_BASE = 1024;var ABORT = false;var EXITSTATUS = 0;function assert(condition, text) {
      if (!condition) {
        abort("Assertion failed: " + text);
      }
    }function getMemory(size) {
      if (!runtimeInitialized) return dynamicAlloc(size);return _malloc(size);
      ...
      var endPtr = idx;while (u8Array[endPtr]) {
        ...
        var str = "";while (1) {
          var u0 = u8Array[idx++];if (!u0) return str;if (!(u0 & 128)) {
      ...
      var size = lengthBytesUTF8(str) + 1;var ret = stackAlloc(size);stringToUTF8Array(str, HEAP8, ret, size);return ret;
    ...
    }var PAGE_SIZE = 16384;var WASM_PAGE_SIZE = 65536;function alignUp(x, multiple) {
      if (x % multiple > 0) {
    ...
    }var TOTAL_STACK = 5242880;var TOTAL_MEMORY = Module["TOTAL_MEMORY"] || 16777216;if (TOTAL_MEMORY < TOTAL_STACK) err("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + TOTAL_MEMORY + "! (TOTAL_STACK=" + TOTAL_STACK + ")");if (Module["buffer"]) {
    ...
    }var runDependencies = 0;var runDependencyWatcher = null;var dependenciesFulfilled = null;function getUniqueRunDependency(id) {
      return id;
    ...
    }var wasmBinaryFile = "RyoCoreCpp.wasm";if (!isDataURI(wasmBinaryFile)) {
      ...
      }env["memory"] = Module["wasmMemory"];var info = { "global": { "NaN": NaN, "Infinity": Infinity }, "global.Math": Math, "env": env, "asm2wasm": asm2wasmImports, "parent": Module };function receiveInstance(instance, module) {
        var exports = instance.exports;if (exports.memory) mergeMemory(exports.memory);Module["asm"] = exports;removeRunDependency("wasm-instantiate");
      ...
      var PAGE_MULTIPLE = 65536;size = alignUp(size, PAGE_MULTIPLE);var old = Module["buffer"];var oldSize = old.byteLength;try {
        var result = Module["wasmMemory"].grow((size - oldSize) / 65536);if (result !== (-1 | 0)) {
      ...
      if (!env["table"]) {
        var TABLE_SIZE = Module["wasmTableSize"];var MAX_TABLE_SIZE = Module["wasmMaxTableSize"];if ((typeof WebAssembly === "undefined" ? "undefined" : _typeof(WebAssembly)) === "object" && typeof WebAssembly.Table === "function") {
        ...
        env["__table_base"] = 0;
      }var exports = createWasm(env);return exports;
    };STATIC_BASE = GLOBAL_BASE;__ATINIT__.push({ func: function func() {
        ...
        __GLOBAL__sub_I_ryo_wallet_utils_cpp();
      } }, { func: function func() {
        ...
        __GLOBAL__sub_I_ryo_address_utils_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_ryo_paymentID_utils_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_ryo_key_image_utils_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_ryo_transfer_utils_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_ryo_fork_rules_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_index_cpp();
      } }, { func: function func() {
        __GLOBAL__sub_I_ryo_mining_utils_cpp();
      } }, { func: function func() {
      ...
      var MAX_ENV_VALUES = 64;var TOTAL_ENV_SIZE = 1024;var poolPtr;var envPtr;if (!___buildEnvironment.called) {
        ___buildEnvironment.called = true;ENV["USER"] = ENV["LOGNAME"] = "web_user";ENV["PATH"] = "/";ENV["PWD"] = "/";ENV["HOME"] = "/home/web_user";ENV["LANG"] = "C.UTF-8";ENV["_"] = Module["thisProgram"];poolPtr = getMemory(TOTAL_ENV_SIZE);envPtr = getMemory(MAX_ENV_VALUES * 4);HEAP32[envPtr >> 2] = poolPtr;HEAP32[environ >> 2] = envPtr;
      } else {
        envPtr = HEAP32[environ >> 2];poolPtr = HEAP32[envPtr >> 2];
      ...
      try {
        ...
        if (!adjusted || EXCEPTIONS.infos[adjusted]) return adjusted;for (var key in EXCEPTIONS.infos) {
          var ptr = +key;var adj = EXCEPTIONS.infos[ptr].adjusted;var len = adj.length;for (var i = 0; i < len; i++) {
            if (adj[i] === adjusted) {
              return ptr;
            }
          }
      ...
      ___setErrNo(1);return -1;
        ...
        if (node.usedBytes == newSize) return;if (newSize == 0) {
          ...
          canOwn = false;if (!length) return 0;var node = stream.node;node.timestamp = Date.now();if (buffer.subarray && (!node.contents || node.contents.subarray)) {
            if (canOwn) {
        ...
        } } };var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, trackingDelegate: {}, tracking: { openFlags: { READ: 1, WRITE: 2 } }, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, handleFSError: function handleFSError(e) {
        ...
        try {
          var node = FS.lookupNode(dir, name);return 17;
        ...
        var old_dirname = PATH.dirname(old_path);var new_dirname = PATH.dirname(new_path);var old_name = PATH.basename(old_path);var new_name = PATH.basename(new_path);var lookup, old_dir, new_dir;try {
          ...
          throw new FS.ErrnoError(16);
        }if (!old_dir || !new_dir) throw new FS.ErrnoError(2);if (old_dir.mount !== new_dir.mount) {
        ...
        if (path === "") {
          ...
          if (!FS.readFiles) FS.readFiles = {};if (!(path in FS.readFiles)) {
            FS.readFiles[path] = 1;console.log("FS.trackingDelegate error on read file: " + path);
          }
        }try {
        ...
        FS.mkdir("/proc");FS.mkdir("/proc/self");FS.mkdir("/proc/self/fd");FS.mount({ mount: function mount() {
            var node = FS.createNode("/proc/self", "fd", 16384 | 511, 73);node.node_ops = { lookup: function lookup(parent, name) {
                var fd = +name;var stream = FS.getStream(fd);if (!stream) throw new FS.ErrnoError(9);var ret = { parent: null, mount: { mountpoint: "fake" }, node_ops: { readlink: function readlink() {
                      return stream.path;
        ...
        if (FS.ErrnoError) return;FS.ErrnoError = function ErrnoError(errno, node) {
          this.node = node;this.setErrno = function (errno) {
            this.errno = errno;
          };this.setErrno(errno);this.message = "FS error";if (this.stack) Object.defineProperty(this, "stack", { value: new Error().stack, writable: true });
        };FS.ErrnoError.prototype = new Error();FS.ErrnoError.prototype.constructor = FS.ErrnoError;[2].forEach(function (code) {
        ...
        }if (!success) ___setErrNo(5);return success;
        ...
        var ret = UTF8ToString(SYSCALLS.get());return ret;
      ...
      SYSCALLS.varargs = varargs;try {
        var stream = SYSCALLS.getStreamFromFD(),
            op = SYSCALLS.get();switch (op) {case 21509:case 21505:
            {
      ...
      }var returns = argTypes[0].name !== "void";var argsWired = new Array(argCount - 2);return function () {
        if (arguments.length !== argCount - 2) {
          throwBindingError("function " + humanName + " called with " + arguments.length + " arguments, expected " + (argCount - 2) + " args!");
        }var destructors = needsDestructorStack ? [] : null;var thisWired;if (isClassMethodFunc) {
          thisWired = argTypes[1].toWireType(destructors, this);
        }for (var i = 0; i < argCount - 2; ++i) {
          argsWired[i] = argTypes[i + 2].toWireType(destructors, arguments[i]);
        }var invokerFuncArgs = isClassMethodFunc ? [cppTargetFunc, thisWired] : [cppTargetFunc];var rv = cppInvokerFunc.apply(null, invokerFuncArgs.concat(argsWired));if (needsDestructorStack) {
      ...
      signature = readLatin1String(signature);function makeDynCaller(dynCall) {
        return function () {
          var args = new Array(arguments.length + 1);args[0] = rawFunction;for (var i = 0; i < arguments.length; i++) {
        ...
        var dc = Module["dynCall_" + signature];if (dc === undefined) {
          dc = Module["dynCall_" + signature.replace(/f/g, "d")];if (dc === undefined) {
      ...
      var oldSize = _emscripten_get_heap_size();var PAGE_MULTIPLE = 65536;var LIMIT = 2147483648 - PAGE_MULTIPLE;if (requestedSize > LIMIT) {
        return false;
      ...
      }var replacement = Module["reallocBuffer"](newSize);if (!replacement || replacement.byteLength != newSize) {
        return false;
      ...
      var self = _llvm_stacksave;var ret = self.LLVM_SAVEDSTACKS[p];self.LLVM_SAVEDSTACKS.splice(p, 1);stackRestore(ret);
    ...
    }function _pthread_mutex_init() {}function _pthread_once(ptr, func) {
      ...
      var tm_zone = HEAP32[tm + 40 >> 2];var date = { tm_sec: HEAP32[tm >> 2], tm_min: HEAP32[tm + 4 >> 2], tm_hour: HEAP32[tm + 8 >> 2], tm_mday: HEAP32[tm + 12 >> 2], tm_mon: HEAP32[tm + 16 >> 2], tm_year: HEAP32[tm + 20 >> 2], tm_wday: HEAP32[tm + 24 >> 2], tm_yday: HEAP32[tm + 28 >> 2], tm_isdst: HEAP32[tm + 32 >> 2], tm_gmtoff: HEAP32[tm + 36 >> 2], tm_zone: tm_zone ? UTF8ToString(tm_zone) : "" };var pattern = UTF8ToString(format);var EXPANSION_RULES_1 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S" };for (var rule in EXPANSION_RULES_1) {
      ...
      switch (name) {case 30:
          ...
          var maxHeapSize = 2 * 1024 * 1024 * 1024 - 65536;return maxHeapSize / PAGE_SIZE;case 132:case 133:case 12:case 137:case 138:case 15:case 235:case 16:case 17:case 18:case 19:case 20:case 149:case 13:case 10:case 236:case 153:case 9:case 21:case 22:case 159:case 154:case 14:case 77:case 78:case 139:case 80:case 81:case 82:case 68:case 67:case 164:case 11:case 29:case 47:case 48:case 95:case 52:case 51:case 46:
    ...
    }embind_init_charCodes();BindingError = Module["BindingError"] = extendError(Error, "BindingError");InternalError = Module["InternalError"] = extendError(Error, "InternalError");init_emval();UnboundTypeError = Module["UnboundTypeError"] = extendError(Error, "UnboundTypeError");function intArrayFromString(stringy, dontAddNull, length) {
    ...
    }Module["wasmTableSize"] = 1100;Module["wasmMaxTableSize"] = 1100;var asmGlobalArg = {};Module.asmLibraryArg = { "g": abort, "ba": setTempRet0, "n": getTempRet0, "V": abortOnCannotGrowMemory, "f": ___assert_fail, "A": ___atomic_fetch_add_8, "K": ___buildEnvironment, "d": ___cxa_allocate_exception, "y": ___cxa_pure_virtual, "x": ___cxa_thread_atexit, "c": ___cxa_throw, "w": ___cxa_uncaught_exception, "v": ___lock, "aa": ___map_file, "u": ___setErrNo, "$": ___syscall140, "_": ___syscall145, "t": ___syscall146, "Z": ___syscall221, "Y": ___syscall3, "X": ___syscall5, "W": ___syscall54, "s": ___syscall6, "U": ___syscall91, "m": ___unlock, "T": __embind_register_bool, "S": __embind_register_emval, "r": __embind_register_float, "R": __embind_register_function, "i": __embind_register_integer, "h": __embind_register_memory_view, "q": __embind_register_std_string, "Q": __embind_register_std_wstring, "P": __embind_register_void, "e": _abort, "O": _emscripten_get_heap_size, "N": _emscripten_memcpy_big, "M": _emscripten_resize_heap, "l": _getenv, "L": _gmtime_r, "z": _llvm_bswap_i64, "k": _llvm_stackrestore, "j": _llvm_stacksave, "p": _llvm_trap, "J": _pthread_cond_wait, "I": _pthread_getspecific, "H": _pthread_key_create, "G": _pthread_mutex_init, "F": _pthread_once, "E": _pthread_setspecific, "D": _signal, "C": _strftime_l, "B": _sysconf, "o": _time, "a": DYNAMICTOP_PTR, "b": ___dso_handle };var asm = Module["asm"](asmGlobalArg, Module.asmLibraryArg, buffer);Module["asm"] = asm;var __GLOBAL__sub_I_account_cpp = Module["__GLOBAL__sub_I_account_cpp"] = function () {
      return Module["asm"]["ca"].apply(null, arguments);
    };var __GLOBAL__sub_I_base58_cpp = Module["__GLOBAL__sub_I_base58_cpp"] = function () {
    ...
    };var __GLOBAL__sub_I_bulletproofs_cc = Module["__GLOBAL__sub_I_bulletproofs_cc"] = function () {
      return Module["asm"]["fa"].apply(null, arguments);
    };var __GLOBAL__sub_I_crypto_cpp = Module["__GLOBAL__sub_I_crypto_cpp"] = function () {
      return Module["asm"]["ga"].apply(null, arguments);
    };var __GLOBAL__sub_I_cryptonote_basic_impl_cpp = Module["__GLOBAL__sub_I_cryptonote_basic_impl_cpp"] = function () {
      return Module["asm"]["ha"].apply(null, arguments);
    };var __GLOBAL__sub_I_cryptonote_format_utils_cpp = Module["__GLOBAL__sub_I_cryptonote_format_utils_cpp"] = function () {
      return Module["asm"]["ia"].apply(null, arguments);
    };var __GLOBAL__sub_I_cryptonote_tx_utils_cpp = Module["__GLOBAL__sub_I_cryptonote_tx_utils_cpp"] = function () {
    ...
    };var __GLOBAL__sub_I_device_default_cpp = Module["__GLOBAL__sub_I_device_default_cpp"] = function () {
      return Module["asm"]["la"].apply(null, arguments);
    };var __GLOBAL__sub_I_electrum_words_cpp = Module["__GLOBAL__sub_I_electrum_words_cpp"] = function () {
      return Module["asm"]["ma"].apply(null, arguments);
    };var __GLOBAL__sub_I_hex_cpp = Module["__GLOBAL__sub_I_hex_cpp"] = function () {
    ...
    };var __GLOBAL__sub_I_logger_cpp = Module["__GLOBAL__sub_I_logger_cpp"] = function () {
      return Module["asm"]["qa"].apply(null, arguments);
    };var __GLOBAL__sub_I_multiexp_cc = Module["__GLOBAL__sub_I_multiexp_cc"] = function () {
      return Module["asm"]["ra"].apply(null, arguments);
    };var __GLOBAL__sub_I_rctOps_cpp = Module["__GLOBAL__sub_I_rctOps_cpp"] = function () {
      return Module["asm"]["sa"].apply(null, arguments);
    };var __GLOBAL__sub_I_rctTypes_cpp = Module["__GLOBAL__sub_I_rctTypes_cpp"] = function () {
      return Module["asm"]["ta"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_address_utils_cpp = Module["__GLOBAL__sub_I_ryo_address_utils_cpp"] = function () {
      return Module["asm"]["ua"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_fork_rules_cpp = Module["__GLOBAL__sub_I_ryo_fork_rules_cpp"] = function () {
      return Module["asm"]["va"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_key_image_utils_cpp = Module["__GLOBAL__sub_I_ryo_key_image_utils_cpp"] = function () {
      return Module["asm"]["wa"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_mining_utils_cpp = Module["__GLOBAL__sub_I_ryo_mining_utils_cpp"] = function () {
      return Module["asm"]["xa"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_paymentID_utils_cpp = Module["__GLOBAL__sub_I_ryo_paymentID_utils_cpp"] = function () {
      return Module["asm"]["ya"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_transfer_utils_cpp = Module["__GLOBAL__sub_I_ryo_transfer_utils_cpp"] = function () {
      return Module["asm"]["za"].apply(null, arguments);
    };var __GLOBAL__sub_I_ryo_wallet_utils_cpp = Module["__GLOBAL__sub_I_ryo_wallet_utils_cpp"] = function () {
      return Module["asm"]["Aa"].apply(null, arguments);
    };var __GLOBAL__sub_I_serial_bridge_index_cpp = Module["__GLOBAL__sub_I_serial_bridge_index_cpp"] = function () {
      return Module["asm"]["Ba"].apply(null, arguments);
    };var __GLOBAL__sub_I_string_tools_cpp = Module["__GLOBAL__sub_I_string_tools_cpp"] = function () {
      return Module["asm"]["Ca"].apply(null, arguments);
    };var __GLOBAL__sub_I_tools__ret_vals_cpp = Module["__GLOBAL__sub_I_tools__ret_vals_cpp"] = function () {
      return Module["asm"]["Da"].apply(null, arguments);
    };var __GLOBAL__sub_I_util_cpp = Module["__GLOBAL__sub_I_util_cpp"] = function () {
      return Module["asm"]["Ea"].apply(null, arguments);
    };var __GLOBAL__sub_I_wipeable_string_cpp = Module["__GLOBAL__sub_I_wipeable_string_cpp"] = function () {
      return Module["asm"]["Fa"].apply(null, arguments);
    ...
    }ExitStatus.prototype = new Error();ExitStatus.prototype.constructor = ExitStatus;var calledMain = false;dependenciesFulfilled = function runCaller() {
      if (!Module["calledRun"]) run();if (!Module["calledRun"]) dependenciesFulfilled = runCaller;
    };Module["callMain"] = function callMain(args) {
      args = args || [];ensureInitRuntime();var argc = args.length + 1;var argv = stackAlloc((argc + 1) * 4);HEAP32[argv >> 2] = allocateUTF8OnStack(Module["thisProgram"]);for (var i = 1; i < argc; i++) {
        HEAP32[(argv >> 2) + i] = allocateUTF8OnStack(args[i - 1]);
      }HEAP32[(argv >> 2) + argc] = 0;try {
        ...
        if (e instanceof ExitStatus) {
          ...
          var toLog = e;if (e && (typeof e === "undefined" ? "undefined" : _typeof(e)) === "object" && e.stack) {
            toLog = [e, e.stack];
          }err("exception thrown: " + toLog);Module["quit"](1, e);
        }
      } finally {
        calledMain = true;
      }
      ...
      if (implicit && Module["noExitRuntime"] && status === 0) {
        ...
        ABORT = true;EXITSTATUS = status;exitRuntime();if (Module["onExit"]) Module["onExit"](status);
      ...
      shouldRunNow = false;
    }Module["noExitRuntime"] = true;run();Module["ready"] = new Promise(function (resolve, reject) {
      delete Module["then"];Module["onAbort"] = function (what) {
        reject(what);
